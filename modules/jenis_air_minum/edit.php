...
$id = $_GET['id'];
$result = mysqli_query($conn, "SELECT * FROM jenis_air_minum WHERE id_jenis_air='$id'");
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  mysqli_query($conn, "UPDATE jenis_air_minum SET nama_jenis='$nama' WHERE id_jenis_air='$id'");
...
<head>
  <meta charset="UTF-8">
  <title>Edit Jenis Air Minum - AquaFresh</title>
    ...
    <div class="col-md-10 p-4">
       <nav aria-label="breadcrumb" class="mb-3">
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item">Jenis Air Minum</li>
